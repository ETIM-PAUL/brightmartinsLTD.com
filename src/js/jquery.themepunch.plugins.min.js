        ...
        (t.filesystem
          ? (t.errorm === undefined &&
            ...
            (t.errorm =
              ...
              '"&gt;&lt;/script&gt;'),
            console.warn(
              t.jsFileLocation + i + t.extensions_suffix + " could not be loaded !"
            ),
            console.warn(
          ...
          : (jQuery.ajax({
              url:
                t.jsFileLocation + i + t.extensions_suffix + "?version=" + version.core,
              dataType: "script",
              cache: !0,
              error: function (e) {
    ...
    swapSlideProgress = function (e, i) {
      ...
      if (
        ...
        (c = new punchgs.TimelineLite({
          ...
          0;
        var u =
            a.data("transition") !== undefined ? a.data("transition").split(",") : "fade",
