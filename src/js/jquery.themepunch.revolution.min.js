      ...
      return (
        ...
        this.each(function () {
          ...
          (e.minHeight =
            ...
            (e.jsFileLocation =
              e.jsFileLocation || getScriptLocation("themepunch.revolution.min.js")),
        ...
        (i && jQuery.isNumeric(i)) || i.match(/to/g)
          ? (1 === i || -1 === i
              ...
              : ((i = jQuery.isNumeric(i) ? i : parseInt(i.split("to")[1], 0)),
                (n = 0 > i ? 0 : i > e.slideamount - 1 ? e.slideamount - 1 : i)),
            t.find(".tp-revslider-slidesli:eq(" + n + ")").addClass("next-revslide"))
          : i &&
        ...
        if (e.fullScreenOffsetContainer !== undefined) {
          ...
          try {
            ...
            e.fullScreenOffset.length > 0
              ? (r -= (jQuery(window).height() * parseInt(e.fullScreenOffset, 0)) / 100)
              : e.fullScreenOffset !== undefined &&
                e.fullScreenOffset.length > 0 &&
      ...
      return jQuery("body").data(e)
        ...
        ? (t.errorm === undefined &&
          ...
          (t.errorm =
            ...
            '"&gt;&lt;/script&gt;'),
          console.warn(
            t.jsFileLocation + e + t.extensions_suffix + " could not be loaded !"
          ),
          console.warn(
    ...
    waitForScripts = function (e, t) {
      ...
      t.addons !== undefined &&
        ...
        ("undefined" !== typeof punchgs &&
          i &&
          (!a.kenburns || (a.kenburns && "undefined" !== typeof _R.stopKenBurn)) &&
          (!a.navigation ||
            (a.navigation && "undefined" !== typeof _R.createNavigation)) &&
          (!a.carousel || (a.carousel && "undefined" !== typeof _R.prepareCarousel)) &&
          (!a.videos || (a.videos && "undefined" !== typeof _R.resetVideo)) &&
          (!a.actions || (a.actions && "undefined" !== typeof _R.checkActions)) &&
          (!a.layeranim ||
            (a.layeranim && "undefined" !== typeof _R.handleStaticLayers)) &&
          (!a.migration || (a.migration && "undefined" !== typeof _R.migration)) &&
          (!a.parallax || (a.parallax && "undefined" !== typeof _R.checkForParallax)) &&
          (a.carousel || (!a.carousel && "undefined" !== typeof _R.animateSlide)))
      ...
      if (
          ...
          e.find(".tp-caption, .rs-background-video-layer").each(function (e) {
            ...
            p !== undefined && _R.checkActions(i, t, p),
              ...
              r ||
                ...
                i.closest("li.tp-revslider-slidesli").addClass("rs-pause-timer-once"),
              r ||
                (1 !== n && "true" !== n && "on" !== n && "no1sttime" !== n) ||
                "loopandnoslidestop" === o ||
                i.closest("li.tp-revslider-slidesli").addClass("rs-pause-timer-always");
          }),
          e.hover(
            function () {
        ...
        e.append(
          ...
          0 === e.find(".tp-bannertimer").length &&
            e.append('<div class="tp-bannertimer" style="visibility:hidden"></div>'),
            ...
            "always" === t.fallbacks.ignoreHeightChanges
              ? ((t.fallbacks.ignoreHeightChangesSize =
                ...
                (i =
                  ...
                  Math.abs(a - t.lastwindowheight) > t.fallbacks.ignoreHeightChangesSize))
              : (i = a != t.lastwindowheight);
          }
          (e.outerWidth(!0) !== t.width || e.is(":hidden") || i) &&
            ((t.lastwindowheight = jQuery(window).height()), containerResized(e, t));
        }),
          hideSliderUnder(e, t),
          contWidthManager(t),
    ...
    containerResized = function (e, t) {
      if (
        ...
        removeSlots(e, t, e, 2),
          ...
          "on" === a.data("kenburns") && _R.startKenBurn(a, t, a.data("kbtl").progress()),
          "on" === i.data("kenburns") && _R.startKenBurn(i, t, i.data("kbtl").progress()),
          _R.animateTheCaptions && _R.animateTheCaptions(a.closest("li"), t, !0),
          _R.manageNavigation && _R.manageNavigation(t);
      }
    },
    setScale = function (e) {
        ...
        t.allli.find(">img").each(function (e) {
          ...
          i.closest(".slotholder").data(n),
            ...
            "none" !== t.dottedOverlay &&
              ...
              i
                .closest(".slotholder")
                .append('<div class="tp-dottedoverlay ' + t.dottedOverlay + '"></div>');
          var r = i.attr("src");
          (n.src = r),
    ...
    waitForCurrentImages = function (e, t, i) {
      ...
      e.find("img,.defaultimg, .tp-svg-layer").each(function () {
        ...
        if (
          (r &&
            ...
            (!r.error && jQuery.now() - i.data("start-to-load") < 5e3
              ...
              : ((r.progress = "failed"),
                r.reported_img ||
                  ((r.reported_img = !0), console.warn(n + "  Could not be loaded !")))),
          1 === t.youtubeapineeded &&
            (!window.YT || YT.Player === undefined) &&
            ((a = !0), jQuery.now() - t.youtubestarttime > 5e3 && 1 !== t.youtubewarning))
        ) {
          t.youtubewarning = !0;
        ...
        if (
          1 === t.vimeoapineeded &&
          !window.Froogaloop &&
          ((a = !0), jQuery.now() - t.vimeostarttime > 5e3 && 1 == t.vimeowarning)
        ) {
          t.vimeowarning = !0;
          ...
          void waitForCurrentImages(a, t, function () {
            a.find(".rs-background-video-layer").each(function () {
              ...
              e.hasClass("HasListener") ||
                (e.data("bgvideo", 1), _R.manageVideoLayer && _R.manageVideoLayer(e, t)),
    ...
    swapSlideProgress = function (e, t, i) {
      ...
      if ("carousel" === e.sliderType)
        ...
        (c = new punchgs.TimelineLite({
          ...
          (u = 0);
        var p =
            n.data("transition") != undefined ? n.data("transition").split(",") : "fade",
        ...
        e.ie &&
          ...
          "on" === o.data("kenburns") &&
            (_R.startKenBurn(o, e), c.add(punchgs.TweenLite.set(o, {autoAlpha: 0}))),
          c.pause();
      }
      _R.scrollHandling &&
      ...
      var a = function () {
        0 === jQuery("body").find(e).length &&
          ...
          1 === e.data("conthover-changed") &&
            ((t.conthover = e.data("conthover")), e.data("conthover-changed", 0)),
      ...
      i.data(
        ...
        e.on("tp-mouseleft", function () {
          (t.mouseoncontainer = !1),
            1 !== e.data("conthover") &&
              "on" === t.navigation.onHoverStop &&
              ((1 === t.viewPort.enable && t.inviewport) || 0 === t.viewPort.enable) &&
